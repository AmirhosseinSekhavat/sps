...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="mt-8 space-y-6" action="<?php echo e(route('auth.verify-otp.verify')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="text-center">
                    <a href="<?php echo e(route('auth.login')); ?>" class="text-blue-600 hover:text-blue-500 text-sm">
...
<?php /**PATH /home/alex/project/pdccut-1/pdccut-app/resources/views/auth/verify-otp.blade.php ENDPATH**/ ?>