            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                        ...
                        <?php if(isset($yearlyPayments) && $yearlyPayments->count() > 0): ?>
                        <div class="space-y-2">
                            <?php $__currentLoopData = $yearlyPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex justify-between items-center">
                                <span class="text-gray-700">پرداخت سال <?php echo e($row->year); ?></span>
                                <span class="font-medium text-green-700"><?php echo e(number_format($row->annual_payment)); ?> ریال</span>
                            </div>
                            ...
                            <div class="border-t border-green-200 pt-2 mt-2 flex justify-between items-center">
                                ...
                                <span class="font-bold text-green-800"><?php echo e(number_format($totalYearlyPayment)); ?> ریال</span>
                            </div>
                        </div>
                        <?php else: ?>
