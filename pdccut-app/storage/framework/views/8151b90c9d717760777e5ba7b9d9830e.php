...
<head>
    ...
    <title>مشاهده کاربر - <?php echo e($user->full_name); ?> - PDCCUT.IR</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center">
                    ...
                    <h1 class="mr-3 text-xl font-semibold text-gray-900">مشاهده کاربر: <?php echo e($user->full_name); ?></h1>
                </div>
            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="flex items-center mb-6">
                    <div class="h-20 w-20 bg-blue-600 rounded-full flex items-center justify-center">
                        <span class="text-white text-2xl font-bold"><?php echo e(substr($user->first_name, 0, 1)); ?></span>
                    </div>
                    <div class="mr-4">
...
<?php /**PATH /home/alex/project/pdccut-1/pdccut-app/resources/views/admin/user/show.blade.php ENDPATH**/ ?>