...
<div class="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="px-4 py-5 sm:p-6">
            <div class="flex items-center mb-6">
                <div class="h-20 w-20 bg-blue-600 rounded-full flex items-center justify-center">
                    <span class="text-white text-2xl font-bold">{{ mb_substr($user->first_name ?? $user->name, 0, 1, 'UTF-8') }}</span>
                </div>
                <div class="mr-4">
                    ...
                    <p class="text-sm text-gray-500">
                        شماره عضویت: {{ $user->membership_number }}
                    </p>
                </div>
            </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">{{ $user->father_name ?? '—' }}</span>
                        </div>
                        <div class="flex justify-between">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">
                                @if($latestCertificate)
                                    {{ number_format($latestCertificate->share_count) }} عدد
                                @else
                                    —
                                @endif
                            </span>
                        ...
                        <div class="flex justify-between">
                            <span class="text-gray-600">سود سالانه (سال {{ $latestCertificate ? $latestCertificate->year : $selectedYear }}):</span>
                            <span class="font-medium">
                                @if($latestCertificate)
                        ...
                        <div class="flex justify-between">
                            <span class="text-gray-600">سود سهام پرداختی سال (سال {{ $latestCertificate ? $latestCertificate->year : $selectedYear }}):</span>
                            <span class="font-medium">
                                @if($latestCertificate)
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="mr-3">
                        ...
                        <p class="text-lg font-semibold text-gray-900">{{ $totalCertificates }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="mr-3">
                        ...
                        <p class="text-lg font-semibold text-gray-900">{{ $totalNotifications - $unreadNotifications }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-gray-50 rounded-lg p-4 mb-4">
        ...
        <div class="flex flex-row-reverse">
            <!-- Y Axis (left in RTL) -->
            <div class="w-16 pr-2" style="height: {{ $chartHeight }}px;">
                <div class="flex flex-col justify-between h-full text-left">
                    @for($i = $steps; $i >= 0; $i--)
                        @php $label = $i * $stepValue; @endphp
                        <div class="text-xs text-gray-600 leading-none">{{ number_format($label) }}</div>
                    @endfor
                </div>
            </div>
            ...
            <div class="relative flex-1 overflow-x-auto">
                <div class="relative" style="height: {{ $chartHeight }}px; min-width: 100%;">
                    <div class="absolute inset-0 pointer-events-none" style="background-image: repeating-linear-gradient(to top, #e5e7eb 0, #e5e7eb 1px, transparent 1px, transparent calc(100% / {{ $steps }}));"></div>
                    ...
                    <div class="absolute inset-0 flex items-end justify-center gap-1 sm:gap-2 md:gap-3" style="direction: ltr;">
                        @foreach($years as $year)
                            ...
                            <div class="flex flex-col items-center justify-end h-full">
                                <div class="bg-gradient-to-t from-red-600 to-red-500 rounded w-3 sm:w-4 md:w-5 lg:w-6 xl:w-7 shadow" style="height: {{ $height }}px;"></div>
                                <div class="mt-2 text-[10px] sm:text-xs text-gray-700">{{ $year }}</div>
                            </div>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <p class="font-medium text-gray-900">{{ $latestCertificate->year }}</p>
                    </div>
                    <div>
